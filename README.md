...
我使用了 [TMDB](https://developer.themoviedb.org/docs/getting-started) API，來取得電影相關資訊
它就像是電影百科全書，擁有非常豐富的資料，隨時隨地為你提供最熱門、即將上映的電影資訊

每部電影點進去就能看到詳細的電影介紹，相關電影功能還會為你推薦類似的精彩電影，保證讓你對這部電影了如指掌
